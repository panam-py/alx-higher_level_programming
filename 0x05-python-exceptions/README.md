...
This directory contains project tasks for **0x05-python_exceptions** done during **Software Engineering training** at **alx**. It aims to learn about exceptions, how to use them, how to use errors and how to raise them in **Python**.
