...
This directory contains project tasks for **0x03-python-data_structures** done during **Software Engineering training** at **alx**. It aims to learn about sets, dictionaries and functions to handle data structures like lambda, map, reduce and filter in **Python**.
